...
+(function LapysJSMain() {
    ...
    /* Global */
        ...
        /* Global
                --- NOTE (Lapys) -> The global object of the current environment (hopefully points to the global object (e.g.: `global`, `window` e.t.c.)).
        ...
        LapysDevelopmentKit = (function() {
            ...
            var LapysDevelopmentKit = new LapysDevelopmentKit;
                ...
                LapysDevelopmentKit.Functions = {
                    ...
                    // Prototype To Array-Like Prototype --- WARN (Lapys) -> Do not utilize the methods & properties generated by this function on the specified Prototype for they are not performance-inclined.
